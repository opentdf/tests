...
def test_nested_stuff():
    ...
    class Outer(construct_typed.DataclassMixin):
        ...
        class C(construct_typed.DataclassMixin):
            f3: str = construct_typed.csfield(
                construct.PascalString(construct.Int8ub, "utf8")
            )
...
def test_sibling_stuff_with_enums():
    ...
    @dataclasses.dataclass
    class C(construct_typed.DataclassMixin):
        f3a: AnEnum = construct_typed.csfield(
            construct_typed.TEnum(construct.Int8ub, AnEnum)
        )
        f3b: str = construct_typed.csfield(
            construct.PascalString(construct.Int8ub, "utf8")
        )
