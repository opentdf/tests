...
def attribute_with_alternate_kas_registration_disabled(
    ...
    assert otdfctl.kas_registry_key_get(kas_entry_km1, key.key.key_id) is None
    attr, _ = _create_keyed_attribute(
        otdfctl,
        temporary_namespace,
