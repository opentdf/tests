"""This short file exposes a wsgi-callable object as app."""

import os

from wsgicors import CORS

from src import eas_app
...
app = CORS(
    ...
    headers=str(
        os.environ.get(
            "WSGI_CORS_HEADERS",
            "Origin, X-Requested-With, Content-Type, Authorization, X-Session-Id, X-Virtru-Client, X-No-Redirect",
        )
    ),
    methods=str(
