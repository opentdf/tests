...
def createTestClientForClientCredentialsFlow(keycloak_admin, keycloak_auth_url):
...
def createTDFRealm(kc_admin_user, kc_admin_pass, kc_url):
    ...
    createTestClientForClientCredentialsFlow(keycloak_admin, kc_url)
